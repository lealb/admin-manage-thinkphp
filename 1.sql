...
(1, 'slackck', 'e10adc3949ba59abbe56e057f20f883e', '876902658@qq.com', '沈利', '15959715286', 150, '127.0.0.1', 112222233, '72ffa9e58f3ed5ae518747e9afa26625', 1),
...
(40, 'Sys/database', 'Excel导入/导出', 1, 1, '', '', 1, 50, 1448613588),
(41, 'Sys/excel_import', 'Excel导入', 1, 0, '', '', 40, 50, 1448613614),
(42, 'Sys/database', 'Excel导出', 1, 1, '', '', 40, 50, 1448613651),
...
CREATE TABLE IF NOT EXISTS `mr_news` (
  ...
  `news_pic_allurl` varchar(255) NOT NULL COMMENT '多图路径',
...
(2, '轮播图片2', 1, '/uploads/Ad/2015-12-29/5681f14409b6a.jpg', '', 1451356484, 50, 1, 0, 0);
...
CREATE TABLE IF NOT EXISTS `mr_source` (
